...
- Joyflix观影平台是一款提供Mac系列使用的原生级的桌面端影视播放应用
- 内置精品影视站，点击顶部状态栏中的内置影视切换观看（内置影视的加载速度取决于你的网速，可能因为网络环境问题加载慢或无法加载，切换或开启优选网站自动优选功能）
- 欢迎开发者社区的积极人员对项目进行二开
...
- 点击观影记录可以查看你的历史浏览记录
- 点击拓展列表中的优选网站，可自动检测网站下次可自动打开最快的影视站
...
- 预加载常用站点，提升加载速度，减少等待时间。会自动统计历史记录中访问频率最高的3个影视站，在应用启动时后台预加载这些站页面资源
- 防止休眠/锁屏
- 崩溃恢复/会话恢复
- 可自动检测更新并实现自动更新
- 观影记录
...
- 本项目仅供学习和个人使用，请勿用于商业用途或公开服务（**禁止用于任何商业用途**），如因公开分享导致的任何法律问题，用户需自行承担责任，项目开发者不对用户的使用行为承担任何法律责任
- 如有问题或建议，欢迎提交 Issue
- 如需分支项目请引用本项目地址
- Joyflix 仅作为影视聚合工具，不存储、上传或分发任何视频内容。所有视频均来自第三方影视站提供的搜索结果。如有侵权内容，请联系相应的内容提供方。
